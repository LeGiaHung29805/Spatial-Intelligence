...
def calculate_capacity_multi():
    # Danh sách các kịch bản bạn đã chọn
    ...
    for level in scenarios:
        ...
        # Hàm định nghĩa sức chứa dựa trên diện tích mái nhà (Theo ghi chép của bạn)
        ...
        # Thống kê kết quả cho kịch bản này
